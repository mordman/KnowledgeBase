...
- [Вопрос](#вопрос)
  - [1. Как это работает](#1-как-это-работает)
    ...
    - [b) `HashSet<Unit>`](#b-hashsetunit)
    - [c) Результат](#c-результат)
  - [2. Как можно улучшить](#2-как-можно-улучшить)
    - [a) Исправить `GetHashCode()`](#a-исправить-gethashcode)
    - [b) Переопределить `Equals()`](#b-переопределить-equals)
    - [c) Использовать неизменяемые объекты](#c-использовать-неизменяемые-объекты)
  - [Итог](#итог)
