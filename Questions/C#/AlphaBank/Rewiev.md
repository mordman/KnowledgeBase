...
## Оглавление
- [Вопрос](#вопрос)
  - [**1. Общий обзор класса `Plane`**](#1-общий-обзор-класса-plane)
    - [**Поля и свойства**](#поля-и-свойства)
    - [**Конструктор**](#конструктор)
    - [**Метод `Register`**](#метод-register)
    - [**Метод `CheckCoordinate`**](#метод-checkcoordinate)
    - [**Метод `ChangePilot`**](#метод-changepilot)
    - [**Метод `StartFlight`**](#метод-startflight)
  - [**2. Общий обзор класса `Person`**](#2-общий-обзор-класса-person)
  - [**3. Архитектурные улучшения**](#3-архитектурные-улучшения)
  - [**4. Пример улучшенного кода**](#4-пример-улучшенного-кода)
  - [**Вывод**](#вывод)
