...
- [1. Теоретическая часть](#1-теоретическая-часть)
  - [Внутреннее устройство .NET и CLR](#внутреннее-устройство-net-и-clr)
  - [Алгоритмы и структуры данных](#алгоритмы-и-структуры-данных)
  - [Архитектура и системный дизайн](#архитектура-и-системный-дизайн)
- [2. Вопросы по языку C#](#2-вопросы-по-языку-c)
  - [Коллекции и массивы](#коллекции-и-массивы)
  - [Memory Management и производительность](#memory-management-и-производительность)
  - [Многопоточность и параллелизм](#многопоточность-и-параллелизм)
  - [Современные возможности C#](#современные-возможности-c)
- [3. Практическая часть](#3-практическая-часть)
  - [Сложные алгоритмы](#сложные-алгоритмы)
  - [High-performance кодирование](#high-performance-кодирование)
  - [Работа с памятью](#работа-с-памятью)
  - [Параллельные алгоритмы](#параллельные-алгоритмы)
  - [Сетевые алгоритмы](#сетевые-алгоритмы)
  - [Машинное обучение](#машинное-обучение)
  - [Базы данных и индексы](#базы-данных-и-индексы)
  - [Компиляторы и интерпретаторы](#компиляторы-и-интерпретаторы)
  - [Криптография](#криптография)
  - [Оптимизация компилятора](#оптимизация-компилятора)
