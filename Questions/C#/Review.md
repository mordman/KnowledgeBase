...
## Оглавление
  - [Провести review следующего класса](#провести-review-следующего-класса)
- [Вариант 1](#вариант-1)
    - [Улучшенный вариант класса `Plane` с описанием возможных ошибок и проблем](#улучшенный-вариант-класса-plane-с-описанием-возможных-ошибок-и-проблем)
  - [Проблемы исходного кода и улучшения:](#проблемы-исходного-кода-и-улучшения)
    - [1. **Проблемы синхронизации**](#1-проблемы-синхронизации)
    - [2. **Неправильная работа с исключением**](#2-неправильная-работа-с-исключением)
    - [3. **Отсутствие проверки ввода**](#3-отсутствие-проверки-ввода)
    - [4. **Потеря потока управления**](#4-потеря-потока-управления)
    - [5. **Опасность использования mutable полей**](#5-опасность-использования-mutable-полей)
    - [6. **Нет интерфейса `IDisposable`**](#6-нет-интерфейса-idisposable)
    - [7. **Неправильное использование методов типа `void` для асинхронных операций**](#7-неправильное-использование-методов-типа-void-для-асинхронных-операций)
    - [Итоги:](#итоги)
- [Вариант 2](#вариант-2)
    - [**1. Потокобезопасность и асинхронность**](#1-потокобезопасность-и-асинхронность)
      - [**Проблемы:**](#проблемы)
      - [**Рекомендации:**](#рекомендации)
    - [**2. Изменение состояния пилота**](#2-изменение-состояния-пилота)
      - [**Проблема:**](#проблема)
      - [**Рекомендация:**](#рекомендация)
    - [**3. Работа с `ConcurrentDictionary`**](#3-работа-с-concurrentdictionary)
      - [**Проблема:**](#проблема)
      - [**Рекомендация:**](#рекомендация)
    - [**4. Сериализация и десериализация**](#4-сериализация-и-десериализация)
      - [**Проблема:**](#проблема)
      - [**Рекомендация:**](#рекомендация)
    - [**5. Общая архитектура**](#5-общая-архитектура)
      ...
      - [**Рекомендации:**](#рекомендации)
    - [**6. Прочее**](#6-прочее)
    - [**Итоговый пример улучшенного кода:**](#итоговый-пример-улучшенного-кода)
