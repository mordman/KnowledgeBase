...
## Оглавление
    ...
    - [**C#/.NET Framework**](#cnet-framework)
    - [**Windows Forms / DevExpress**](#windows-forms-devexpress)
    - [**ADO.NET**](#adonet)
    - [**JSON/XML/XSLT/CSS/HTML**](#jsonxmlxsltcsshtml)
    - [**Python**](#python)
- [Вместо этого:](#вместо-этого)
- [Можно написать так:](#можно-написать-так)
- [Внутренняя функция multiplier помнит, что x = 3.](#внутренняя-функция-multiplier-помнит-что-x-3)
    - [**Git**](#git)
- [Создание и переход на новую ветку](#создание-и-переход-на-новую-ветку)
- [... работа, коммиты ...](#работа-коммиты)
- [Переключение на основную ветку (например, main)](#переключение-на-основную-ветку-например-main)
- [Слияние feature-branch в main](#слияние-feature-branch-в-main)
- [Найти коммит, где файл был удален](#найти-коммит-где-файл-был-удален)
- [Восстановить файл из этого коммита](#восстановить-файл-из-этого-коммита)
- [Или, если удаление было в последнем коммите:](#или-если-удаление-было-в-последнем-коммите)
    - [**Scrum**](#scrum)
    - [**Практические задания**](#практические-задания)
- [В командной строке (bash/cmd):](#в-командной-строке-bashcmd)
- [1. Создать виртуальное окружение](#1-создать-виртуальное-окружение)
- [2. Активировать его](#2-активировать-его)
- [Linux/macOS:](#linuxmacos)
- [Windows:](#windows)
- [myenv\Scripts\activate](#myenvscriptsactivate)
- [3. Установить библиотеку requests](#3-установить-библиотеку-requests)
- [script.py](#scriptpy)
- [4. Запустить скрипт](#4-запустить-скрипт)
