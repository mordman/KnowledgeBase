...
## Оглавление
- [1. <anchor id="p1"/>Порождающие шаблоны (Creational Patterns)](#1-anchor-idp1порождающие-шаблоны-creational-patterns)
  - [1. Singleton (Одиночка)](#1-singleton-одиночка)
  - [2. Factory Method (Фабричный метод)](#2-factory-method-фабричный-метод)
  - [3. Abstract Factory (Абстрактная фабрика)](#3-abstract-factory-абстрактная-фабрика)
  - [4. Builder (Строитель)](#4-builder-строитель)
  - [5. Prototype (Прототип)](#5-prototype-прототип)
  - [6. Object Pool (Пул объектов)](#6-object-pool-пул-объектов)
  - [7. Lazy Initialization (Ленивая инициализация)](#7-lazy-initialization-ленивая-инициализация)
  - [8. Dependency Injection (Внедрение зависимостей)](#8-dependency-injection-внедрение-зависимостей)
  - [9. Multiton](#9-multiton)
  - [10. Simple Factory (Простая фабрика)](#10-simple-factory-простая-фабрика)
- [2. <anchor id="p2"/>Структурные шаблоны (Structural Patterns)](#2-anchor-idp2структурные-шаблоны-structural-patterns)
  - [1. Adapter (Адаптер)](#1-adapter-адаптер)
  - [2. Decorator (Декоратор)](#2-decorator-декоратор)
  - [3. Facade (Фасад)](#3-facade-фасад)
  - [4. Composite (Компоновщик)](#4-composite-компоновщик)
  - [5. Proxy (Заместитель)](#5-proxy-заместитель)
  - [6. Flyweight (Приспособленец)](#6-flyweight-приспособленец)
  - [7. Bridge (Мост)](#7-bridge-мост)
  - [8. Decorator vs. Inheritance](#8-decorator-vs-inheritance)
  - [9. Module (Модуль)](#9-module-модуль)
  - [10. Twin](#10-twin)
- [3. <anchor id="p3"/>Поведенческие шаблоны (Behavioral Patterns)](#3-anchor-idp3поведенческие-шаблоны-behavioral-patterns)
  - [1. Observer (Наблюдатель)](#1-observer-наблюдатель)
  - [2. Strategy (Стратегия)](#2-strategy-стратегия)
  - [3. Command (Команда)](#3-command-команда)
  - [4. State (Состояние)](#4-state-состояние)
  - [5. Chain of Responsibility (Цепочка обязанностей)](#5-chain-of-responsibility-цепочка-обязанностей)
  - [6. Iterator (Итератор)](#6-iterator-итератор)
  - [7. Mediator (Посредник)](#7-mediator-посредник)
  - [8. Memento (Хранитель)](#8-memento-хранитель)
  - [9. Visitor (Посетитель)](#9-visitor-посетитель)
  - [10. Template Method (Шаблонный метод)](#10-template-method-шаблонный-метод)
