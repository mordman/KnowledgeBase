...
## Оглавление
- [**9. Serverless-архитектура**](#9-serverless-архитектура)
  - [**Описание**](#описание)
- [**Подстили и шаблоны Serverless-архитектуры**](#подстили-и-шаблоны-serverless-архитектуры)
  - [**9.1. Function as a Service (FaaS)**](#91-function-as-a-service-faas)
    - [**Описание**](#описание)
    - [**Преимущества**](#преимущества)
    - [**Недостатки**](#недостатки)
    - [**Пример**](#пример)
  - [**9.2. Backend for Frontend (BFF)**](#92-backend-for-frontend-bff)
    - [**Описание**](#описание)
    - [**Преимущества**](#преимущества)
    - [**Пример**](#пример)
  - [**9.3. Event-Driven Serverless**](#93-event-driven-serverless)
    - [**Описание**](#описание)
    - [**Преимущества**](#преимущества)
    - [**Пример**](#пример)
  - [**9.4. Serverless Microservices**](#94-serverless-microservices)
    - [**Описание**](#описание)
    - [**Преимущества**](#преимущества)
    - [**Пример**](#пример)
  - [**9.5. Serverless с управляемыми сервисами**](#95-serverless-с-управляемыми-сервисами)
    - [**Описание**](#описание)
    - [**Преимущества**](#преимущества)
    - [**Пример**](#пример)
- [**Пример реализации на C# (AWS Lambda)**](#пример-реализации-на-c-aws-lambda)
- [**Когда использовать Serverless-архитектуру?**](#когда-использовать-serverless-архитектуру)
