...
## Оглавление
- [**7. Чистая архитектура (Clean Architecture)**](#7-чистая-архитектура-clean-architecture)
  - [**Описание**](#описание)
- [**Основные принципы Clean Architecture**](#основные-принципы-clean-architecture)
- [**Слои Clean Architecture**](#слои-clean-architecture)
  - [**7.1. Enterprise Business Rules (внутренний слой)**](#71-enterprise-business-rules-внутренний-слой)
    - [**Описание**](#описание)
    - [**Пример**](#пример)
  - [**7.2. Application Business Rules**](#72-application-business-rules)
    - [**Описание**](#описание)
    - [**Пример**](#пример)
  - [**7.3. Interface Adapters**](#73-interface-adapters)
    - [**Описание**](#описание)
    - [**Пример**](#пример)
  - [**7.4. Frameworks & Drivers (внешний слой)**](#74-frameworks-drivers-внешний-слой)
    - [**Описание**](#описание)
    - [**Пример**](#пример)
- [**Взаимодействие между слоями**](#взаимодействие-между-слоями)
- [**Преимущества Clean Architecture**](#преимущества-clean-architecture)
- [**Недостатки Clean Architecture**](#недостатки-clean-architecture)
- [**Пример структуры проекта на C#**](#пример-структуры-проекта-на-c)
- [**Когда использовать Clean Architecture?**](#когда-использовать-clean-architecture)
