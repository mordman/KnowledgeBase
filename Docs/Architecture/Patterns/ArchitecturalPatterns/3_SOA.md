...
## Оглавление
- [**3. Сервис-ориентированная архитектура (SOA, Service-Oriented Architecture)**](#3-сервис-ориентированная-архитектура-soa-service-oriented-architecture)
  - [**Описание**](#описание)
- [**Подстили и шаблоны**](#подстили-и-шаблоны)
  - [**3.1. Enterprise Service Bus (ESB)**](#31-enterprise-service-bus-esb)
    - [**Описание**](#описание)
    - [**Преимущества**](#преимущества)
    - [**Недостатки**](#недостатки)
    - [**Пример**](#пример)
  - [**3.2. Orchestration (Оркестрация)**](#32-orchestration-оркестрация)
    - [**Описание**](#описание)
    - [**Преимущества**](#преимущества)
    - [**Недостатки**](#недостатки)
    - [**Пример**](#пример)
  - [**3.3. Choreography (Хореография)**](#33-choreography-хореография)
    - [**Описание**](#описание)
    - [**Преимущества**](#преимущества)
    - [**Недостатки**](#недостатки)
    - [**Пример**](#пример)
  - [**3.4. Service Registry and Discovery**](#34-service-registry-and-discovery)
    - [**Описание**](#описание)
    - [**Преимущества**](#преимущества)
    - [**Недостатки**](#недостатки)
    - [**Пример**](#пример)
  - [**3.5. Service Mesh**](#35-service-mesh)
    - [**Описание**](#описание)
    - [**Преимущества**](#преимущества)
    - [**Недостатки**](#недостатки)
    - [**Пример**](#пример)
- [**Пример реализации на C# (SOAP-сервис)**](#пример-реализации-на-c-soap-сервис)
- [**Когда использовать SOA?**](#когда-использовать-soa)
