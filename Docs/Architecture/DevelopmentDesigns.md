...
## Оглавление
  - [**1. TDD (Test-Driven Development)**](#1-tdd-test-driven-development)
    - [**Концепция**](#концепция)
    - [**Применение**](#применение)
    - [**Сценарии**](#сценарии)
    - [**Пример**](#пример)
- [1. Тест (не проходит)](#1-тест-не-проходит)
- [2. Минимальный код (тест проходит)](#2-минимальный-код-тест-проходит)
- [3. Рефакторинг (если нужно)](#3-рефакторинг-если-нужно)
    - [**Building Blocks**](#building-blocks)
    - [**Схема**](#схема)
  - [**2. BDD (Behavior-Driven Development)**](#2-bdd-behavior-driven-development)
    - [**Концепция**](#концепция)
    - [**Применение**](#применение)
    - [**Сценарии**](#сценарии)
    - [**Пример**](#пример)
  ...
  - [**3. DDD (Domain-Driven Design)**](#3-ddd-domain-driven-design)
    ...
    - [**Building Blocks**](#building-blocks)
    - [**Схема**](#схема)
  - [**4. FDD (Feature-Driven Development)**](#4-fdd-feature-driven-development)
    - [**Концепция**](#концепция)
    - [**Применение**](#применение)
    - [**Сценарии**](#сценарии)
    - [**Пример**](#пример)
    - [**Building Blocks**](#building-blocks)
    - [**Схема**](#схема)
  - [**5. ATDD (Acceptance Test-Driven Development)**](#5-atdd-acceptance-test-driven-development)
    - [**Концепция**](#концепция)
    - [**Применение**](#применение)
    - [**Сценарии**](#сценарии)
    - [**Пример**](#пример)
    - [**Building Blocks**](#building-blocks)
    - [**Схема**](#схема)
  - [**6. MDD (Model-Driven Development)**](#6-mdd-model-driven-development)
    - [**Концепция**](#концепция)
    - [**Применение**](#применение)
    - [**Сценарии**](#сценарии)
    - [**Пример**](#пример)
