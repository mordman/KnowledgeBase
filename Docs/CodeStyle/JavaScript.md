...
- [**3. Точка с запятой**](#3-точка-с-запятой)
- [**4. Пустые строки**](#4-пустые-строки)
- [**5. Импорты**](#5-импорты)
- [**6. Пробелы**](#6-пробелы)
- [**7. Именование**](#7-именование)
- [**8. Объявление переменных**](#8-объявление-переменных)
- [**9. Комментарии**](#9-комментарии)
- [**10. Строки**](#10-строки)
- [**11. Условные операторы**](#11-условные-операторы)
- [**12. Работа с объектами и массивами**](#12-работа-с-объектами-и-массивами)
- [**13. Асинхронный код**](#13-асинхронный-код)
- [**14. Обработка ошибок**](#14-обработка-ошибок)
- [**15. Пример кода в стиле JavaScript**](#15-пример-кода-в-стиле-javascript)
