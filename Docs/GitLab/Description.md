...
## Оглавление
- [**Основные возможности GitLab**](#основные-возможности-gitlab)
- [**Как начать использовать GitLab?**](#как-начать-использовать-gitlab)
  ...
  - [**4. Создание и управление задачами (Issues)**](#4-создание-и-управление-задачами-issues)
  - [**5. Работа с Merge Requests**](#5-работа-с-merge-requests)
    - [**Как создать Merge Request?**](#как-создать-merge-request)
  - [**6. Настройка CI/CD**](#6-настройка-cicd)
    - [**Пример файла `.gitlab-ci.yml`:**](#пример-файла-gitlab-ciyml)
    - [**Как работает CI/CD в GitLab?**](#как-работает-cicd-в-gitlab)
  - [**7. Использование Docker-реестра**](#7-использование-docker-реестра)
    - [**Как использовать реестр?**](#как-использовать-реестр)
  - [**8. Управление Wiki и документацией**](#8-управление-wiki-и-документацией)
- [**Преимущества GitLab**](#преимущества-gitlab)
- [**Недостатки GitLab**](#недостатки-gitlab)
- [**Когда использовать GitLab?**](#когда-использовать-gitlab)
