...
## Оглавление
  - [**Функциональное тестирование: подробный разбор**](#функциональное-тестирование-подробный-разбор)
- [**Цели функционального тестирования**](#цели-функционального-тестирования)
- [**Уровни функционального тестирования**](#уровни-функционального-тестирования)
  - [**1. Модульное тестирование (Unit Testing)**](#1-модульное-тестирование-unit-testing)
  - [**2. Интеграционное тестирование (Integration Testing)**](#2-интеграционное-тестирование-integration-testing)
  - [**3. Системное тестирование (System Testing)**](#3-системное-тестирование-system-testing)
  - [**4. Регрессионное тестирование (Regression Testing)**](#4-регрессионное-тестирование-regression-testing)
  - [**5. Приемочное тестирование (Acceptance Testing)**](#5-приемочное-тестирование-acceptance-testing)
- [**Как создавать тест-кейсы?**](#как-создавать-тест-кейсы)
  - [**Пример тест-кейса для функции авторизации:**](#пример-тест-кейса-для-функции-авторизации)
- [**Инструменты для функционального тестирования**](#инструменты-для-функционального-тестирования)
