...
## Оглавление
- [**1. Кластеризованный индекс (Clustered Index)**](#1-кластеризованный-индекс-clustered-index)
  - [**Что это?**](#что-это)
  - [**Особенности:**](#особенности)
  - [**Пример:**](#пример)
- [**2. Некластеризованный индекс (Nonclustered Index)**](#2-некластеризованный-индекс-nonclustered-index)
  - [**Что это?**](#что-это)
  - [**Особенности:**](#особенности)
  - [**Пример:**](#пример)
- [**3. Как работают вместе?**](#3-как-работают-вместе)
  - [**Пример работы:**](#пример-работы)
- [**4. Когда что использовать?**](#4-когда-что-использовать)
- [**5. Пример с реальными данными**](#5-пример-с-реальными-данными)
  - [**Таблица:**](#таблица)
  - [**Запросы:**](#запросы)
- [**6. Под капотом: как хранятся данные**](#6-под-капотом-как-хранятся-данные)
  - [**Кластеризованный индекс:**](#кластеризованный-индекс)
  - [**Некластеризованный индекс:**](#некластеризованный-индекс)
- [**7. Плюсы и минусы**](#7-плюсы-и-минусы)
- [**8. Практические рекомендации**](#8-практические-рекомендации)
  - [**Краткая выкладка по статье**](#краткая-выкладка-по-статье)
  - [**Сводная таблица для SQL Server, Oracle и PostgreSQL**](#сводная-таблица-для-sql-server-oracle-и-postgresql)
  - [**Примеры для Oracle и PostgreSQL**](#примеры-для-oracle-и-postgresql)
    - [**Oracle**](#oracle)
