...
## Оглавление
- [**Что такое Deadlock (Взаимоблокировка) в базе данных?**](#что-такое-deadlock-взаимоблокировка-в-базе-данных)
- [**Пример Deadlock**](#пример-deadlock)
- [**Как избежать Deadlock?**](#как-избежать-deadlock)
  - [**1. Избегание условий возникновения Deadlock**](#1-избегание-условий-возникновения-deadlock)
  - [**2. Практические методы предотвращения**](#2-практические-методы-предотвращения)
    - [**А. Порядок блокировки ресурсов**](#а-порядок-блокировки-ресурсов)
    - [**Б. Уменьшение времени удержания блокировок**](#б-уменьшение-времени-удержания-блокировок)
    - [**В. Использование оптимистичной блокировки**](#в-использование-оптимистичной-блокировки)
    - [**Г. Разделение транзакций на более мелкие**](#г-разделение-транзакций-на-более-мелкие)
    - [**Д. Использование таймаутов**](#д-использование-таймаутов)
    - [**Е. Мониторинг и автоматическое разрешение**](#е-мониторинг-и-автоматическое-разрешение)
  - [**3. Как СУБД разрешают Deadlock?**](#3-как-субд-разрешают-deadlock)
- [**Пример кода для обработки Deadlock (на Python с SQLAlchemy)**](#пример-кода-для-обработки-deadlock-на-python-с-sqlalchemy)
- [**Вывод**](#вывод)
