...
## Оглавление
- [**1. Partitioning (Партиционирование)**](#1-partitioning-партиционирование)
  - [**Типы партиционирования в PostgreSQL**](#типы-партиционирования-в-postgresql)
  - [**Пример: Range Partitioning по дате**](#пример-range-partitioning-по-дате)
- [**2. Sharding (Шардинг)**](#2-sharding-шардинг)
  - [**Сценарии использования шардинга**](#сценарии-использования-шардинга)
  - [**Пример: Шардинг с помощью Citus (расширение для PostgreSQL)**](#пример-шардинг-с-помощью-citus-расширение-для-postgresql)
- [**Сравнение Partitioning и Sharding**](#сравнение-partitioning-и-sharding)
