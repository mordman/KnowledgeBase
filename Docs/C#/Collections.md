...
## Оглавление
  - [**1. List<T>**](#1-listt)
  - [**2. Dictionary<TKey, TValue>**](#2-dictionarytkey-tvalue)
  - [**3. HashSet<T>**](#3-hashsett)
  - [**4. Array (массив)**](#4-array-массив)
  - [**Ключевые моменты:**](#ключевые-моменты)
- [Уникальность элементов в коллекциях C# обеспечивается разными механизмами в зависимости от типа коллекции. Вот как это работает под капотом:](#уникальность-элементов-в-коллекциях-c-обеспечивается-разными-механизмами-в-зависимости-от-типа-коллекции-вот-как-это-работает-под-капотом)
  - [**1. HashSet<T>**](#1-hashsett)
  - [**2. Dictionary<TKey, TValue>**](#2-dictionarytkey-tvalue)
  - [**3. List<T> и Array**](#3-listt-и-array)
  - [**Ключевые моменты:**](#ключевые-моменты)
  - [**Пример с кастомным объектом**](#пример-с-кастомным-объектом)
