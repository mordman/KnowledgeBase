...
## Оглавление
- [**Основные возможности и цели Aspire:**](#основные-возможности-и-цели-aspire)
- [**Пример использования**](#пример-использования)
- [**Как начать работать с Aspire?**](#как-начать-работать-с-aspire)
- [**Отличия от классического ASP.NET Core**](#отличия-от-классического-aspnet-core)
