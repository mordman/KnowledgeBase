...
## Оглавление
- [**Основные возможности BenchmarkDotNet**](#основные-возможности-benchmarkdotnet)
- [**Пример использования**](#пример-использования)
  - [1. Установка](#1-установка)
  - [2. Написание бенчмарка](#2-написание-бенчмарка)
  - [3. Запуск бенчмарка](#3-запуск-бенчмарка)
  - [4. Результаты](#4-результаты)
- [**Параметризованные бенчмарки**](#параметризованные-бенчмарки)
- [**Дополнительные возможности**](#дополнительные-возможности)
- [**Когда использовать BenchmarkDotNet?**](#когда-использовать-benchmarkdotnet)
