...
## Оглавление
- [**1. Как C# работает с памятью?**](#1-как-c-работает-с-памятью)
  - [**Типы памяти в C#**](#типы-памяти-в-c)
  - [**Как выделяется память?**](#как-выделяется-память)
- [**2. Как работает Garbage Collector (GC) в C#?**](#2-как-работает-garbage-collector-gc-в-c)
  - [**Основные принципы GC:**](#основные-принципы-gc)
  - [**Поколения объектов (Generations)**](#поколения-объектов-generations)
  - [**Как происходит сборка мусора?**](#как-происходит-сборка-мусора)
  - [**Типы сборок мусора**](#типы-сборок-мусора)
- [**3. Практические советы по оптимизации памяти**](#3-практические-советы-по-оптимизации-памяти)
