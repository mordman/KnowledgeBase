...
## Оглавление
  - [**1. `Task.WaitAll`**](#1-taskwaitall)
  - [**2. `Task.WaitAny`**](#2-taskwaitany)
  - [**3. `Task.WhenAll`**](#3-taskwhenall)
  - [**4. `Task.WhenAny`**](#4-taskwhenany)
  - [**5. `Task.WhenEach`**](#5-taskwheneach)
  - [**Сводная таблица**](#сводная-таблица)
  - [**Когда что использовать?**](#когда-что-использовать)
- [**`Task.WhenEach` в .NET 9**](#taskwheneach-в-net-9)
  - [**Что делает?**](#что-делает)
  - [**Сигнатура метода**](#сигнатура-метода)
  - [**Пример использования**](#пример-использования)
- [**Сравнение с другими методами**](#сравнение-с-другими-методами)
- [**Когда использовать `WhenEach`?**](#когда-использовать-wheneach)
- [**Пример с отменой**](#пример-с-отменой)
  - [**Вывод**](#вывод)
