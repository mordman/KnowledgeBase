...
## Оглавление
- [**Основное назначение MediatR**](#основное-назначение-mediatr)
- [**Основные компоненты MediatR**](#основные-компоненты-mediatr)
- [**Сценарии использования MediatR**](#сценарии-использования-mediatr)
  - [1. **Обработка команд (Command)**](#1-обработка-команд-command)
  - [2. **Обработка запросов (Query)**](#2-обработка-запросов-query)
  - [3. **Использование в ASP.NET Core**](#3-использование-в-aspnet-core)
  - [4. **Пайплайны (Pipeline)**](#4-пайплайны-pipeline)
- [**Преимущества MediatR**](#преимущества-mediatr)
- [**Когда использовать MediatR?**](#когда-использовать-mediatr)
