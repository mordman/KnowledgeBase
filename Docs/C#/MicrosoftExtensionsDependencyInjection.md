...
## Оглавление
- [**Зачем нужен Microsoft.Extensions.DependencyInjection?**](#зачем-нужен-microsoftextensionsdependencyinjection)
  - [**1. Управление зависимостями**](#1-управление-зависимостями)
  - [**2. Поддержка различных жизненных циклов объектов**](#2-поддержка-различных-жизненных-циклов-объектов)
  - [**3. Интеграция с фреймворками**](#3-интеграция-с-фреймворками)
- [**Примеры использования**](#примеры-использования)
  - [**1. Базовый пример: регистрация и внедрение зависимости**](#1-базовый-пример-регистрация-и-внедрение-зависимости)
    - [**Шаг 1: Установка пакета**](#шаг-1-установка-пакета)
    - [**Шаг 2: Регистрация зависимостей**](#шаг-2-регистрация-зависимостей)
    - [**Шаг 3: Использование зависимости**](#шаг-3-использование-зависимости)
  - [**2. Пример в ASP.NET Core**](#2-пример-в-aspnet-core)
    - [**Использование в контроллере**](#использование-в-контроллере)
  - [**3. Пример с разными жизненными циклами**](#3-пример-с-разными-жизненными-циклами)
