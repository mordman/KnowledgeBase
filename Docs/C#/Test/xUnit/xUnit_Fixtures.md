...
## Оглавление
- [**Зачем нужны Fixtures?**](#зачем-нужны-fixtures)
  - [**1. Совместное использование ресурсов**](#1-совместное-использование-ресурсов)
  - [**2. Изоляция тестов**](#2-изоляция-тестов)
  - [**3. Упрощение кода тестов**](#3-упрощение-кода-тестов)
  - [**4. Управление жизненным циклом ресурсов**](#4-управление-жизненным-циклом-ресурсов)
- [**Типы Fixtures в xUnit**](#типы-fixtures-в-xunit)
  - [**1. `IClassFixture<TFixture>`**](#1-iclassfixturetfixture)
  - [**2. `ICollectionFixture<TFixture>`**](#2-icollectionfixturetfixture)
- [**Когда использовать Fixtures?**](#когда-использовать-fixtures)
- [**Пример с восстановлением состояния**](#пример-с-восстановлением-состояния)
- [**Вывод**](#вывод)
