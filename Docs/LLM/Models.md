...
## Оглавление
- [Список модель](#список-модель)
  - [Links](#links)
  - [1. Универсальные модели "Top-Tier" (Лучшие для большинства задач)](#1-универсальные-модели-top-tier-лучшие-для-большинства-задач)
  - [2. Программирование и генерация кода](#2-программирование-и-генерация-кода)
  - [3. Диалоговые системы и чат-боты](#3-диалоговые-системы-и-чат-боты)
  - [4. Работа с длинными документами и анализом данных](#4-работа-с-длинными-документами-и-анализом-данных)
  - [5. Креативная генерация (тексты, сценарии, идеи)](#5-креативная-генерация-тексты-сценарии-идеи)
  - [6. Мультимодальные модели (понимают не только текст)](#6-мультимодальные-модели-понимают-не-только-текст)
  - [7. Модели для локального использования (Privacy & Cost Control)](#7-модели-для-локального-использования-privacy-cost-control)
  - [Китайские модели: Обзор и экосистема](#китайские-модели-обзор-и-экосистема)
  - [Как выбрать модель? Обновленная памятка:](#как-выбрать-модель-обновленная-памятка)
