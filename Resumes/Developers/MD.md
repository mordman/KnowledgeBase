...
**CI/CD:** Team Foundation Server (TFS), GitLab, СФЕРА(Т1), Jenkins, SVN
...
**Проект:** БАНК СНГБ - банкинг и брокерское обслуживание  
**Роль:** Oracle DB Developer/ Oracle Forms / .NET / JAVA  
**Задачи:**
- Разработка и поддержка отчетности, банковских процессов, брокерского обслуживания.
- Сервис печати.
- Разработка базы знаний.
- Настройка CI/CD на GitLab.
- Работа с Docker.
- Разработка и оптимизация SQL-запросов.
- Внедрение, тестирование ИИ инструментов

**Достижения:**  
База знаний, усовершенствования процессов разработки, сервис печати.
...
Исправление в **Telegraf** модуля работы с MSSQl Server для корректного сбора метрик.
