...
- [**Как работает код**](#как-работает-код)
  - [**1. Инициализация и подготовка**](#1-инициализация-и-подготовка)
  - [**2. Первый запрос LINQ (без `ToList()`)**](#2-первый-запрос-linq-без-tolist)
  - [**3. Второй запрос LINQ (с `ToList()`)**](#3-второй-запрос-linq-с-tolist)
- [**Что можно улучшить**](#что-можно-улучшить)
  - [**1. Побочные эффекты в LINQ-запросах**](#1-побочные-эффекты-в-linq-запросах)
  - [**2. Отложенное выполнение**](#2-отложенное-выполнение)
- [**Выводы**](#выводы)
