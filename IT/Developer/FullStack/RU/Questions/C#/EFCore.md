...
## Оглавление
    - [**1. Что такое Entity Framework Core?**](#1-что-такое-entity-framework-core)
    - [**2. В чём разница между EF Core и EF6?**](#2-в-чём-разница-между-ef-core-и-ef6)
    - [**3. Что такое DbContext и зачем он нужен?**](#3-что-такое-dbcontext-и-зачем-он-нужен)
    - [**4. Как работает отслеживание изменений (Change Tracking) в EF Core?**](#4-как-работает-отслеживание-изменений-change-tracking-в-ef-core)
    - [**5. Что такое миграции (Migrations) и как они работают?**](#5-что-такое-миграции-migrations-и-как-они-работают)
- [Команды в Package Manager Console](#команды-в-package-manager-console)
    - [**6. Какие подходы к загрузке данных поддерживает EF Core?**](#6-какие-подходы-к-загрузке-данных-поддерживает-ef-core)
    - [**7. Как оптимизировать производительность запросов в EF Core?**](#7-как-оптимизировать-производительность-запросов-в-ef-core)
    - [**8. Что такое Shadow Properties?**](#8-что-такое-shadow-properties)
    - [**9. Как реализовать транзакции в EF Core?**](#9-как-реализовать-транзакции-в-ef-core)
    - [**10. Что такое Value Objects и как их использовать?**](#10-что-такое-value-objects-и-как-их-использовать)
    - [**11. Как работать с JSON-полями в EF Core?**](#11-как-работать-с-json-полями-в-ef-core)
    - [**12. Что такое Global Query Filters?**](#12-что-такое-global-query-filters)
    - [**13. Как реализовать многопоточность с EF Core?**](#13-как-реализовать-многопоточность-с-ef-core)
    - [**14. Что такое Raw SQL и когда его использовать?**](#14-что-такое-raw-sql-и-когда-его-использовать)
    - [**15. Как настроить связь "многие ко многим" без сущности-посредника?**](#15-как-настроить-связь-многие-ко-многим-без-сущности-посредника)
    - [**16. Что такое TPH, TPT, TPC в EF Core?**](#16-что-такое-tph-tpt-tpc-в-ef-core)
    - [**17. Как реализовать soft delete?**](#17-как-реализовать-soft-delete)
    - [**18. Как работать с составными ключами?**](#18-как-работать-с-составными-ключами)
    - [**19. Что такое Interceptors в EF Core?**](#19-что-такое-interceptors-в-ef-core)
    - [**20. Как тестировать код с EF Core?**](#20-как-тестировать-код-с-ef-core)
- [Joins](#joins)
    - [**1. Как выполнить INNER JOIN в EF Core?**](#1-как-выполнить-inner-join-в-ef-core)
    - [**2. Как выполнить LEFT JOIN (или LEFT OUTER JOIN) в EF Core?**](#2-как-выполнить-left-join-или-left-outer-join-в-ef-core)
    - [**3. Как выполнить RIGHT JOIN в EF Core?**](#3-как-выполнить-right-join-в-ef-core)
    - [**4. Как выполнить FULL JOIN (или FULL OUTER JOIN) в EF Core?**](#4-как-выполнить-full-join-или-full-outer-join-в-ef-core)
    - [**5. Как выполнить CROSS JOIN в EF Core?**](#5-как-выполнить-cross-join-в-ef-core)
    - [**6. Как выполнить соединение с несколькими условиями?**](#6-как-выполнить-соединение-с-несколькими-условиями)
    - [**7. Как выполнить соединение с фильтрацией?**](#7-как-выполнить-соединение-с-фильтрацией)
    - [**8. Как выполнить соединение с агрегацией?**](#8-как-выполнить-соединение-с-агрегацией)
    - [**9. Как выполнить соединение с подзапросами (Subquery Join)?**](#9-как-выполнить-соединение-с-подзапросами-subquery-join)
    - [**10. Как выполнить соединение с группировкой (Group Join)?**](#10-как-выполнить-соединение-с-группировкой-group-join)
    - [**11. Как выполнить соединение с несколькими таблицами?**](#11-как-выполнить-соединение-с-несколькими-таблицами)
    - [**12. Как выполнить соединение с использованием навигационных свойств и фильтрацией?**](#12-как-выполнить-соединение-с-использованием-навигационных-свойств-и-фильтрацией)
    - [**13. Как выполнить соединение с использованием Raw SQL и LINQ?**](#13-как-выполнить-соединение-с-использованием-raw-sql-и-linq)
    - [**14. Как выполнить соединение с использованием временных таблиц?**](#14-как-выполнить-соединение-с-использованием-временных-таблиц)
    - [**15. Как выполнить соединение с использованием анонимных типов и проекции?**](#15-как-выполнить-соединение-с-использованием-анонимных-типов-и-проекции)
    - [**16. Как выполнить соединение с использованием внешних ключей и фильтрацией?**](#16-как-выполнить-соединение-с-использованием-внешних-ключей-и-фильтрацией)
    - [**17. Как выполнить соединение с использованием агрегатных функций?**](#17-как-выполнить-соединение-с-использованием-агрегатных-функций)
    - [**18. Как выполнить соединение с использованием сложных условий?**](#18-как-выполнить-соединение-с-использованием-сложных-условий)
    - [**19. Как выполнить соединение с использованием подзапроса в SELECT?**](#19-как-выполнить-соединение-с-использованием-подзапроса-в-select)
    - [**20. Как выполнить соединение с использованием нескольких условий и сортировки?**](#20-как-выполнить-соединение-с-использованием-нескольких-условий-и-сортировки)
    - [**1. Как настроить соединение "один-ко-многим" с помощью Fluent API?**](#1-как-настроить-соединение-один-ко-многим-с-помощью-fluent-api)
    - [**2. Как настроить соединение "многие-ко-многим" без сущности-посредника в Fluent API?**](#2-как-настроить-соединение-многие-ко-многим-без-сущности-посредника-в-fluent-api)
    - [**3. Как настроить соединение "один-к-одному" с помощью Fluent API?**](#3-как-настроить-соединение-один-к-одному-с-помощью-fluent-api)
    - [**4. Как настроить составной внешний ключ для соединения?**](#4-как-настроить-составной-внешний-ключ-для-соединения)
    - [**5. Как настроить каскадное удаление для соединения?**](#5-как-настроить-каскадное-удаление-для-соединения)
    - [**6. Как настроить соединение с фильтрацией (Filtered Include) в Fluent API?**](#6-как-настроить-соединение-с-фильтрацией-filtered-include-в-fluent-api)
    - [**7. Как настроить соединение с использованием Shadow Properties?**](#7-как-настроить-соединение-с-использованием-shadow-properties)
    - [**8. Как настроить соединение с использованием альтернативного ключа?**](#8-как-настроить-соединение-с-использованием-альтернативного-ключа)
    - [**9. Как настроить соединение с использованием конвертеров значений (Value Converters)?**](#9-как-настроить-соединение-с-использованием-конвертеров-значений-value-converters)
    - [**10. Как настроить соединение с использованием индексов?**](#10-как-настроить-соединение-с-использованием-индексов)
    - [**11. Как настроить соединение с использованием ограничений (Constraints)?**](#11-как-настроить-соединение-с-использованием-ограничений-constraints)
    - [**12. Как настроить соединение с использованием таблицы-посредника для связи "многие-ко-многим"?**](#12-как-настроить-соединение-с-использованием-таблицы-посредника-для-связи-многие-ко-многим)
    - [**13. Как настроить соединение с использованием наследования (TPH, TPT, TPC)?**](#13-как-настроить-соединение-с-использованием-наследования-tph-tpt-tpc)
    - [**14. Как настроить соединение с использованием владельца (Owned Entity)?**](#14-как-настроить-соединение-с-использованием-владельца-owned-entity)
    - [**15. Как настроить соединение с использованием вычисляемых свойств?**](#15-как-настроить-соединение-с-использованием-вычисляемых-свойств)
- [**10 вопросов по соединениям с несколькими таблицами** в **Entity Framework Core**, включая сложные сценарии и примеры кода:](#10-вопросов-по-соединениям-с-несколькими-таблицами-в-entity-framework-core-включая-сложные-сценарии-и-примеры-кода)
    - [**1. Как выполнить соединение трёх таблиц с фильтрацией?**](#1-как-выполнить-соединение-трёх-таблиц-с-фильтрацией)
    - [**2. Как выполнить соединение четырёх таблиц с проекцией?**](#2-как-выполнить-соединение-четырёх-таблиц-с-проекцией)
    - [**3. Как выполнить соединение с агрегацией по нескольким таблицам?**](#3-как-выполнить-соединение-с-агрегацией-по-нескольким-таблицам)
    - [**4. Как выполнить соединение с подзапросами для нескольких таблиц?**](#4-как-выполнить-соединение-с-подзапросами-для-нескольких-таблиц)
    - [**5. Как выполнить соединение с использованием навигационных свойств для нескольких таблиц?**](#5-как-выполнить-соединение-с-использованием-навигационных-свойств-для-нескольких-таблиц)
    - [**6. Как выполнить соединение с фильтрацией по нескольким таблицам?**](#6-как-выполнить-соединение-с-фильтрацией-по-нескольким-таблицам)
    - [**7. Как выполнить соединение с сортировкой по нескольким таблицам?**](#7-как-выполнить-соединение-с-сортировкой-по-нескольким-таблицам)
    - [**8. Как выполнить соединение с группировкой по нескольким таблицам?**](#8-как-выполнить-соединение-с-группировкой-по-нескольким-таблицам)
    - [**9. Как выполнить соединение с использованием Raw SQL для нескольких таблиц?**](#9-как-выполнить-соединение-с-использованием-raw-sql-для-нескольких-таблиц)
    - [**10. Как выполнить соединение с использованием временных таблиц для нескольких таблиц?**](#10-как-выполнить-соединение-с-использованием-временных-таблиц-для-нескольких-таблиц)
