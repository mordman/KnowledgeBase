...
- **Основные файлы в дистрибутиве**:
  ...
  - `examples/` — папка с примерами XML, XSLT, XSL-FO
  - `docs/` — локальная копия документации
- **Конфигурация**: Файл `fop.xconf` позволяет настраивать шрифты, рендереры и другие параметры.
