...
## Оглавление
- [**Для чего нужен Apache FOP?**](#для-чего-нужен-apache-fop)
- [**Сценарии использования**](#сценарии-использования)
- [**Пример использования Apache FOP на C#**](#пример-использования-apache-fop-на-c)
  - [1. **Установка NuGet-пакетов**](#1-установка-nuget-пакетов)
  - [2. **Пример кода на C#**](#2-пример-кода-на-c)
  - [**Пояснения к коду:**](#пояснения-к-коду)
- [**Типичный процесс работы с FOP**](#типичный-процесс-работы-с-fop)
- [**Пример XSL-FO (фрагмент)**](#пример-xsl-fo-фрагмент)
