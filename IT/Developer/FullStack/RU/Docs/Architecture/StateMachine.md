...
## Оглавление
- [1. Основные понятия автомата](#1-основные-понятия-автомата)
  - [**Состояние (State)**](#состояние-state)
  - [**Переход (Transition)**](#переход-transition)
  - [**Событие (Event)**](#событие-event)
- [2. Как автомат работает в `async`/`await`](#2-как-автомат-работает-в-asyncawait)
  - [**Пример: простой асинхронный метод**](#пример-простой-асинхронный-метод)
  - [**Сгенерированный автомат**](#сгенерированный-автомат)
- [3. Как автомат управляет выполнением](#3-как-автомат-управляет-выполнением)
- [4. Зачем это нужно](#4-зачем-это-нужно)
- [5. Аналогия из реальной жизни](#5-аналогия-из-реальной-жизни)
- [1. Схема работы автомата](#1-схема-работы-автомата)
  - [**Состояния автомата**](#состояния-автомата)
  - [**Диаграмма переходов**](#диаграмма-переходов)
- [2. Пошаговое выполнение](#2-пошаговое-выполнение)
  - [**Шаг 1: Начало выполнения**](#шаг-1-начало-выполнения)
  - [**Шаг 2: Первый await**](#шаг-2-первый-await)
  - [**Шаг 3: Продолжение после первого await**](#шаг-3-продолжение-после-первого-await)
  - [**Шаг 4: Второй await**](#шаг-4-второй-await)
  - [**Шаг 5: Продолжение после второго await**](#шаг-5-продолжение-после-второго-await)
  - [**Шаг 6: Завершение**](#шаг-6-завершение)
- [3. Визуализация в виде таблицы](#3-визуализация-в-виде-таблицы)
- [4. Ключевые моменты](#4-ключевые-моменты)
- [5. Аналогия с реальной жизнью](#5-аналогия-с-реальной-жизнью)
