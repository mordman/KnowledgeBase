...
- [**Основные принципы CQRS**](#основные-принципы-cqrs)
  - [1. **Разделение моделей**](#1-разделение-моделей)
  - [2. **Разные модели данных**](#2-разные-модели-данных)
  - [3. **Независимое масштабирование**](#3-независимое-масштабирование)
- [**Сценарии использования CQRS**](#сценарии-использования-cqrs)
  - [1. **Сложные бизнес-процессы**](#1-сложные-бизнес-процессы)
  - [2. **Высокая нагрузка на чтение**](#2-высокая-нагрузка-на-чтение)
  - [3. **Разные требования к данным**](#3-разные-требования-к-данным)
...
- [**Пример реализации CQRS**](#пример-реализации-cqrs)
  - [**1. Команды (Write Model)**](#1-команды-write-model)
  - [**2. Запросы (Read Model)**](#2-запросы-read-model)
