...
## Оглавление
  - [**1. Single Responsibility Principle (SRP) — Принцип единственной ответственности**](#1-single-responsibility-principle-srp-принцип-единственной-ответственности)
  - [**2. Open/Closed Principle (OCP) — Принцип открытости/закрытости**](#2-openclosed-principle-ocp-принцип-открытостизакрытости)
  - [**3. Liskov Substitution Principle (LSP) — Принцип подстановки Барбары Лисков**](#3-liskov-substitution-principle-lsp-принцип-подстановки-барбары-лисков)
  - [**4. Interface Segregation Principle (ISP) — Принцип разделения интерфейсов**](#4-interface-segregation-principle-isp-принцип-разделения-интерфейсов)
  - [**5. Dependency Inversion Principle (DIP) — Принцип инверсии зависимостей**](#5-dependency-inversion-principle-dip-принцип-инверсии-зависимостей)
    - [**Итоги**](#итоги)
- [Пример рефакторинга](#пример-рефакторинга)
  - [**Исходный код (с нарушениями SOLID)**](#исходный-код-с-нарушениями-solid)
    - [**Класс `OrderProcessor`**](#класс-orderprocessor)
    - [**Проблемы в исходном коде:**](#проблемы-в-исходном-коде)
  - [**Рефакторинг (соблюдение SOLID)**](#рефакторинг-соблюдение-solid)
    - [**1. Разделение ответственности (SRP, ISP, DIP)**](#1-разделение-ответственности-srp-isp-dip)
      - [**Интерфейсы:**](#интерфейсы)
    - [**2. Реализация компонентов**](#2-реализация-компонентов)
      - [**Валидация заказа:**](#валидация-заказа)
      - [**Сохранение заказа в БД:**](#сохранение-заказа-в-бд)
      - [**Отправка уведомления:**](#отправка-уведомления)
      - [**Логирование:**](#логирование)
    - [**3. Новый `OrderProcessor` (OCP, DIP)**](#3-новый-orderprocessor-ocp-dip)
    - [**4. Пример использования (Inversion of Control)**](#4-пример-использования-inversion-of-control)
  - [**Преимущества рефакторинга:**](#преимущества-рефакторинга)
