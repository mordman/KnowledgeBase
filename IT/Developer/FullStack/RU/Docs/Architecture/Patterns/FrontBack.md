...
## Оглавление
- [FrontEnd шаблоны проектирования](#frontend-шаблоны-проектирования)
  - [1. **Компонентный подход (Component Pattern)**](#1-компонентный-подход-component-pattern)
  - [2. **HOC (Higher-Order Component)**](#2-hoc-higher-order-component)
  - [3. **Render Props**](#3-render-props)
  - [4. **Custom Hooks**](#4-custom-hooks)
  - [5. **Flux/Redux Pattern**](#5-fluxredux-pattern)
  - [6. **Provider Pattern**](#6-provider-pattern)
  - [7. **Compound Components**](#7-compound-components)
  - [8. **Container/Presentational Pattern**](#8-containerpresentational-pattern)
- [BackEnd шаблоны проектирования](#backend-шаблоны-проектирования)
...
- [Рекомендации по выбору шаблонов](#рекомендации-по-выбору-шаблонов)
