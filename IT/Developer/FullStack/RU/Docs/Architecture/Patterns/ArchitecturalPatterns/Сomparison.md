...
## Оглавление
- [Сравнение архитектурных шаблонов](#сравнение-архитектурных-шаблонов)
  - [**Ключевые различия**](#ключевые-различия)
  - [**Сценарии использования**](#сценарии-использования)
  - [**MSA (Microservice Architecture) vs SOA (Service-Oriented Architecture): Основные различия**](#msa-microservice-architecture-vs-soa-service-oriented-architecture-основные-различия)
    - [**1. Структура и размер сервисов**](#1-структура-и-размер-сервисов)
    - [**2. Связанность (Coupling)**](#2-связанность-coupling)
    - [**3. Управление данными**](#3-управление-данными)
    - [**4. Развёртывание**](#4-развёртывание)
    - [**5. Технологический стек**](#5-технологический-стек)
  - [**Сценарии использования**](#сценарии-использования)
    - [**SOA подходит, если:**](#soa-подходит-если)
    - [**MSA подходит, если:**](#msa-подходит-если)
  - [**Вывод**](#вывод)
