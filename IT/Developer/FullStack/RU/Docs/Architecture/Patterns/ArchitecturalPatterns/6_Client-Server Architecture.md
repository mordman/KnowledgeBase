...
## Оглавление
- [**6. Клиент-серверная архитектура (Client-Server Architecture)**](#6-клиент-серверная-архитектура-client-server-architecture)
  - [**Описание**](#описание)
- [**Подстили и шаблоны**](#подстили-и-шаблоны)
  - [**6.1. Thin Client (Тонкий клиент)**](#61-thin-client-тонкий-клиент)
    - [**Описание**](#описание)
    - [**Преимущества**](#преимущества)
    - [**Недостатки**](#недостатки)
    - [**Пример**](#пример)
  - [**6.2. Thick Client (Толстый клиент)**](#62-thick-client-толстый-клиент)
    - [**Описание**](#описание)
    - [**Преимущества**](#преимущества)
    - [**Недостатки**](#недостатки)
    - [**Пример**](#пример)
  - [**6.3. Master-Slave**](#63-master-slave)
    - [**Описание**](#описание)
    - [**Преимущества**](#преимущества)
    - [**Недостатки**](#недостатки)
    - [**Пример**](#пример)
  - [**6.4. Peer-to-Peer (P2P)**](#64-peer-to-peer-p2p)
    - [**Описание**](#описание)
    - [**Преимущества**](#преимущества)
    - [**Недостатки**](#недостатки)
    - [**Пример**](#пример)
  - [**6.5. RESTful API**](#65-restful-api)
    - [**Описание**](#описание)
    - [**Преимущества**](#преимущества)
    - [**Недостатки**](#недостатки)
    - [**Пример**](#пример)
  - [**6.6. GraphQL**](#66-graphql)
    - [**Описание**](#описание)
    - [**Преимущества**](#преимущества)
    - [**Недостатки**](#недостатки)
    - [**Пример**](#пример)
- [**Пример реализации на C# (RESTful API)**](#пример-реализации-на-c-restful-api)
- [**Когда использовать клиент-серверную архитектуру?**](#когда-использовать-клиент-серверную-архитектуру)
