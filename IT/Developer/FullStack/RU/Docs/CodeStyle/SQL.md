...
## Оглавление
- [**1. Регистр и форматирование**](#1-регистр-и-форматирование)
- [**2. Именование**](#2-именование)
- [**3. Псевдонимы (Aliases)**](#3-псевдонимы-aliases)
- [**4. Условия и операторы**](#4-условия-и-операторы)
- [**5. JOIN-ы**](#5-join-ы)
- [**6. Подзапросы**](#6-подзапросы)
- [**7. Комментарии**](#7-комментарии)
- [**8. Транзакции**](#8-транзакции)
- [**9. Избегайте `SELECT *`**](#9-избегайте-select)
- [**10. Индексация и производительность**](#10-индексация-и-производительность)
- [**Пример полного запроса**](#пример-полного-запроса)
