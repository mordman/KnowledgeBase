...
## Оглавление
    ...
    - [**3. Организация кода**](#3-организация-кода)
    - [**4. Комментарии**](#4-комментарии)
    - [**5. Использование `var`**](#5-использование-var)
    - [**6. Асинхронный код**](#6-асинхронный-код)
    - [**7. Обработка исключений**](#7-обработка-исключений)
    - [**8. Использование `using`**](#8-использование-using)
    - [**9. Null-значения**](#9-null-значения)
    - [**10. LINQ**](#10-linq)
    - [**Инструменты для проверки стиля**](#инструменты-для-проверки-стиля)
- [CodeStyle Detail](#codestyle-detail)
  - [1. Соглашения по именованию](#1-соглашения-по-именованию)
    ...
    - [**Константы и статические поля**](#константы-и-статические-поля)
    - [**Enums**](#enums)
  - [2. Структура кода и форматирование](#2-структура-кода-и-форматирование)
    - [**Расположение членов класса**](#расположение-членов-класса)
    - [**Форматирование и отступы**](#форматирование-и-отступы)
    - [**Фигурные скобки**](#фигурные-скобки)
  - [3. Модификаторы доступа](#3-модификаторы-доступа)
    - [**Явное указание модификаторов**](#явное-указание-модификаторов)
    - [**Порядок модификаторов**](#порядок-модификаторов)
  - [4. Работа с исключениями](#4-работа-с-исключениями)
    - [**Обработка исключений**](#обработка-исключений)
    - [**Создание пользовательских исключений**](#создание-пользовательских-исключений)
  - [5. Работа с коллекциями и LINQ](#5-работа-с-коллекциями-и-linq)
    - [**Инициализация коллекций**](#инициализация-коллекций)
    - [**LINQ стиль**](#linq-стиль)
  - [6. Асинхронное программирование](#6-асинхронное-программирование)
    - [**Async/await паттерны**](#asyncawait-паттерны)
  ...
  - [8. Тестирование](#8-тестирование)
    - [**Структура unit-тестов**](#структура-unit-тестов)
  - [9. Конфигурация и настройки](#9-конфигурация-и-настройки)
    - [**Классы конфигурации**](#классы-конфигурации)
  - [10. Best Practices и антипаттерны](#10-best-practices-и-антипаттерны)
    - [**ПРАВИЛЬНО**](#правильно)
    - [**НЕПРАВИЛЬНО**](#неправильно)
  - [11. .editorconfig пример](#11-editorconfig-пример)
- [EditorConfig для C#](#editorconfig-для-c)
- [Стиль именования](#стиль-именования)
- [Форматирование](#форматирование)
- [Качество кода](#качество-кода)
  - [Ключевые правила CodeStyle для C#:](#ключевые-правила-codestyle-для-c)
