...
## Оглавление
- [1. **MemoryCache (встроенный кэш в памяти)**](#1-memorycache-встроенный-кэш-в-памяти)
  - [Пример использования `MemoryCache`:](#пример-использования-memorycache)
- [2. **Distributed Cache (распределённый кэш)**](#2-distributed-cache-распределённый-кэш)
  - [Пример использования **Redis** в C#:](#пример-использования-redis-в-c)
    - [Установка:](#установка)
    - [Пример кода:](#пример-кода)
- [3. **Response Caching (кэширование HTTP-ответов)**](#3-response-caching-кэширование-http-ответов)
  - [Пример использования в ASP.NET Core:](#пример-использования-в-aspnet-core)
- [4. **Output Caching (кэширование вывода)**](#4-output-caching-кэширование-вывода)
  - [Пример использования в ASP.NET Core:](#пример-использования-в-aspnet-core)
