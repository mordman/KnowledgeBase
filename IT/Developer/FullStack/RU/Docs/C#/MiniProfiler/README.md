...
## Оглавление
- [**Описание MiniProfiler**](#описание-miniprofiler)
    - [**Сценарии использования**](#сценарии-использования)
    - [**Примеры кода**](#примеры-кода)
      - [**1. Установка и настройка MiniProfiler в ASP.NET Core**](#1-установка-и-настройка-miniprofiler-в-aspnet-core)
      - [**2. Профилирование SQL-запросов в Entity Framework Core**](#2-профилирование-sql-запросов-в-entity-framework-core)
      - [**3. Профилирование произвольного кода**](#3-профилирование-произвольного-кода)
      - [**4. Профилирование HTTP-запросов**](#4-профилирование-http-запросов)
    - [**Пример вывода MiniProfiler**](#пример-вывода-miniprofiler)
