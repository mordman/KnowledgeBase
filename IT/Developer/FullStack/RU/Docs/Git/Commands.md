...
## Оглавление
  - [Подробное описание основных команд Git с примерами](#подробное-описание-основных-команд-git-с-примерами)
- [**1. Инициализация и настройка репозитория**](#1-инициализация-и-настройка-репозитория)
  - [**`git init`**](#git-init)
  - [**`git clone <url>`**](#git-clone-url)
- [**2. Работа с изменениями**](#2-работа-с-изменениями)
  - [**`git status`**](#git-status)
  - [**`git add <файл>`**](#git-add-файл)
  - [**`git commit -m "сообщение"`**](#git-commit-m-сообщение)
  - [**`git diff`**](#git-diff)
- [**3. Работа с ветками**](#3-работа-с-ветками)
  - [**`git branch`**](#git-branch)
  - [**`git branch <название>`**](#git-branch-название)
  - [**`git checkout <название>`**](#git-checkout-название)
  - [**`git checkout -b <название>`**](#git-checkout-b-название)
  - [**`git merge <ветка>`**](#git-merge-ветка)
  - [**`git branch -d <название>`**](#git-branch-d-название)
- [**4. Работа с удалённым репозиторием**](#4-работа-с-удалённым-репозиторием)
  - [**`git remote add <имя> <url>`**](#git-remote-add-имя-url)
  - [**`git fetch`**](#git-fetch)
  - [**`git pull`**](#git-pull)
  - [**`git push`**](#git-push)
- [**5. История и отмена изменений**](#5-история-и-отмена-изменений)
  - [**`git log`**](#git-log)
  - [**`git reset <коммит>`**](#git-reset-коммит)
  - [**`git revert <коммит>`**](#git-revert-коммит)
- [**Merge и Rebase: подробное описание и примеры**](#merge-и-rebase-подробное-описание-и-примеры)
  - [**Merge**](#merge)
  - [**Rebase**](#rebase)
  - [**Сравнение Merge и Rebase**](#сравнение-merge-и-rebase)
