...
## Оглавление
  ...
  - [3. **Kibana**](#3-kibana)
  - [**Как работает стек ELK?**](#как-работает-стек-elk)
  - [**Где применяется ELK?**](#где-применяется-elk)
  - [**Плюсы ELK**](#плюсы-elk)
  - [**Шаги для развёртывания ELK с Docker**](#шаги-для-развёртывания-elk-с-docker)
    - [1. **Установите Docker и Docker Compose**](#1-установите-docker-и-docker-compose)
    - [2. **Создайте файл `docker-compose.yml`**](#2-создайте-файл-docker-composeyml)
    - [3. **Создайте папки для конфигурации Logstash**](#3-создайте-папки-для-конфигурации-logstash)
    - [4. **Добавьте конфигурацию Logstash**](#4-добавьте-конфигурацию-logstash)
    - [5. **Запустите стек ELK**](#5-запустите-стек-elk)
    - [6. **Проверьте работу**](#6-проверьте-работу)
  - [**Дополнительные настройки**](#дополнительные-настройки)
- [Дополнительная информация](#дополнительная-информация)
    - [**1. Компоненты ELK-стека**](#1-компоненты-elk-стека)
    - [**2. Преимущества ELK-стека**](#2-преимущества-elk-стека)
    - [**3. Недостатки ELK-стека**](#3-недостатки-elk-стека)
    - [**4. Применение ELK-стека**](#4-применение-elk-стека)
    - [**5. Установка и настройка**](#5-установка-и-настройка)
