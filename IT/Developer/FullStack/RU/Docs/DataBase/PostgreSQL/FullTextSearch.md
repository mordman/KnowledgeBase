...
## Оглавление
- [**1. Как работает `LIKE '%text%'`**](#1-как-работает-like-text)
  - [**1.1. Проблема с `LIKE '%text%'`**](#11-проблема-с-like-text)
    - [**Пример**](#пример)
- [**2. Полнотекстовый поиск в PostgreSQL**](#2-полнотекстовый-поиск-в-postgresql)
  - [**2.1. Как работает полнотекстовый поиск**](#21-как-работает-полнотекстовый-поиск)
  - [**2.2. Индексы для полнотекстового поиска**](#22-индексы-для-полнотекстового-поиска)
    - [**Пример**](#пример)
  - [**2.3. Автоматическое обновление `tsvector`**](#23-автоматическое-обновление-tsvector)
- [**3. Сравнение `LIKE '%text%'` и полнотекстового поиска**](#3-сравнение-like-text-и-полнотекстового-поиска)
- [**4. Когда использовать `LIKE '%text%'`**](#4-когда-использовать-like-text)
- [**5. Пример: Поиск с ранжированием**](#5-пример-поиск-с-ранжированием)
- [**6. Выводы**](#6-выводы)
