...
## Оглавление
- [**1. Основные механизмы обработки ошибок**](#1-основные-механизмы-обработки-ошибок)
  - [**1.1. Блок `BEGIN ... EXCEPTION ... END`**](#11-блок-begin-exception-end)
    - [**Синтаксис:**](#синтаксис)
  - [**1.2. Типы ошибок**](#12-типы-ошибок)
- [**2. Примеры обработки ошибок**](#2-примеры-обработки-ошибок)
  - [**2.1. Простая обработка ошибок в блоке `DO`**](#21-простая-обработка-ошибок-в-блоке-do)
  - [**2.2. Обработка ошибок в функции**](#22-обработка-ошибок-в-функции)
  - [**2.3. Обработка ошибок в транзакции**](#23-обработка-ошибок-в-транзакции)
  - [**2.4. Обработка ошибок с использованием `SQLSTATE`**](#24-обработка-ошибок-с-использованием-sqlstate)
  - [**2.5. Обработка ошибок в процедуре**](#25-обработка-ошибок-в-процедуре)
- [**3. Использование `RAISE` для генерации ошибок**](#3-использование-raise-для-генерации-ошибок)
  - [**3.1. Генерация пользовательских ошибок**](#31-генерация-пользовательских-ошибок)
  - [**3.2. Генерация ошибок с указанием `SQLSTATE`**](#32-генерация-ошибок-с-указанием-sqlstate)
- [**4. Логирование ошибок**](#4-логирование-ошибок)
  - [**4.1. Логирование ошибок в таблицу**](#41-логирование-ошибок-в-таблицу)
- [**5. Повторное выполнение операций при ошибках**](#5-повторное-выполнение-операций-при-ошибках)
  - [**5.1. Повторное выполнение операции с ограничением по количеству попыток**](#51-повторное-выполнение-операции-с-ограничением-по-количеству-попыток)
- [**6. Обработка ошибок в триггерах**](#6-обработка-ошибок-в-триггерах)
  - [**6.1. Пример триггера с обработкой ошибок**](#61-пример-триггера-с-обработкой-ошибок)
- [**7. Обработка ошибок в анонимных блоках**](#7-обработка-ошибок-в-анонимных-блоках)
  - [**7.1. Пример анонимного блока с обработкой ошибок**](#71-пример-анонимного-блока-с-обработкой-ошибок)
- [**8. Обработка ошибок в курсорах**](#8-обработка-ошибок-в-курсорах)
  - [**8.1. Пример использования курсора с обработкой ошибок**](#81-пример-использования-курсора-с-обработкой-ошибок)
- [**Вывод**](#вывод)
- [**Пример вложенной обработки ошибок**](#пример-вложенной-обработки-ошибок)
  - [**Сценарий:**](#сценарий)
  - [**1. Вложенная обработка ошибок в анонимном блоке**](#1-вложенная-обработка-ошибок-в-анонимном-блоке)
  - [**2. Вложенная обработка ошибок в функции**](#2-вложенная-обработка-ошибок-в-функции)
  - [**3. Вложенная обработка ошибок в процедуре**](#3-вложенная-обработка-ошибок-в-процедуре)
  - [**4. Вложенная обработка ошибок в триггере**](#4-вложенная-обработка-ошибок-в-триггере)
- [**Вывод**](#вывод)
