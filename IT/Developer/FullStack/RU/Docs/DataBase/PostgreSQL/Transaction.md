...
## Оглавление
- [**Типы транзакций в PostgreSQL**](#типы-транзакций-в-postgresql)
  - [**1. Простые транзакции**](#1-простые-транзакции)
  - [**2. Вложенные транзакции (Savepoints)**](#2-вложенные-транзакции-savepoints)
  - [**3. Распределённые транзакции (2PC)**](#3-распределённые-транзакции-2pc)
- [**Уровни изоляции транзакций**](#уровни-изоляции-транзакций)
- [**Особенности транзакций в PostgreSQL**](#особенности-транзакций-в-postgresql)
- [**Примеры использования**](#примеры-использования)
  - [**1. Перевод средств между счётами**](#1-перевод-средств-между-счётами)
  - [**2. Откат при ошибке**](#2-откат-при-ошибке)
  - [**3. Использование точек сохранения**](#3-использование-точек-сохранения)
- [**Выводы**](#выводы)
- [**Уровни изоляции транзакций**](#уровни-изоляции-транзакций)
- [**1. Уровни изоляции в PostgreSQL**](#1-уровни-изоляции-в-postgresql)
- [**2. Проблемы, связанные с уровнями изоляции**](#2-проблемы-связанные-с-уровнями-изоляции)
  - [**2.1. Грязное чтение (Dirty Read)**](#21-грязное-чтение-dirty-read)
  - [**2.2. Неповторяющееся чтение (Non-Repeatable Read)**](#22-неповторяющееся-чтение-non-repeatable-read)
  - [**2.3. Фантомное чтение (Phantom Read)**](#23-фантомное-чтение-phantom-read)
- [**3. Когда использовать каждый уровень изоляции?**](#3-когда-использовать-каждый-уровень-изоляции)
  - [**3.1. Read Committed (по умолчанию)**](#31-read-committed-по-умолчанию)
  - [**3.2. Repeatable Read**](#32-repeatable-read)
  - [**3.3. Serializable**](#33-serializable)
- [**4. Примеры использования уровней изоляции**](#4-примеры-использования-уровней-изоляции)
  - [**4.1. Read Committed (по умолчанию)**](#41-read-committed-по-умолчанию)
  - [**4.2. Repeatable Read**](#42-repeatable-read)
  - [**4.3. Serializable**](#43-serializable)
- [**5. Как избежать проблем на разных уровнях изоляции?**](#5-как-избежать-проблем-на-разных-уровнях-изоляции)
  - [**5.1. Избегание неповторяющегося чтения**](#51-избегание-неповторяющегося-чтения)
  - [**5.2. Избегание фантомов**](#52-избегание-фантомов)
  - [**5.3. Оптимизация производительности**](#53-оптимизация-производительности)
- [**6. Как проверить текущий уровень изоляции?**](#6-как-проверить-текущий-уровень-изоляции)
- [**7. Итоговые рекомендации**](#7-итоговые-рекомендации)
- [**8. Пример: Оптимизация уровня изоляции**](#8-пример-оптимизация-уровня-изоляции)
