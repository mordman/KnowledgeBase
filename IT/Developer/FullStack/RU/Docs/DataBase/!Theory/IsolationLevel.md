...
## Оглавление
- [Уровни изоляции транзакций: теория и практика](#уровни-изоляции-транзакций-теория-и-практика)
- [**1. Теоретическая часть**](#1-теоретическая-часть)
  - [**1.1. Проблемы многопользовательского доступа**](#11-проблемы-многопользовательского-доступа)
  - [**1.2. Уровни изоляции по стандарту ANSI/ISO SQL**](#12-уровни-изоляции-по-стандарту-ansiiso-sql)
- [**2. Практическая часть: уровни изоляции в различных СУБД**](#2-практическая-часть-уровни-изоляции-в-различных-субд)
  - [**2.1. PostgreSQL**](#21-postgresql)
    - [**Примеры использования в PostgreSQL**](#примеры-использования-в-postgresql)
  - [**2.2. MySQL/InnoDB**](#22-mysqlinnodb)
    - [**Примеры использования в MySQL**](#примеры-использования-в-mysql)
  - [**2.3. Microsoft SQL Server**](#23-microsoft-sql-server)
    - [**Примеры использования в SQL Server**](#примеры-использования-в-sql-server)
  - [**2.4. Oracle**](#24-oracle)
    - [**Примеры использования в Oracle**](#примеры-использования-в-oracle)
- [**3. Сценарии использования уровней изоляции**](#3-сценарии-использования-уровней-изоляции)
