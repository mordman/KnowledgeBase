...
## Оглавление
- [**Цели нормализации:**](#цели-нормализации)
- [**Основные нормальные формы:**](#основные-нормальные-формы)
  - [**1. Первая нормальная форма (1НФ)**](#1-первая-нормальная-форма-1нф)
  - [**2. Вторая нормальная форма (2НФ)**](#2-вторая-нормальная-форма-2нф)
  - [**3. Третья нормальная форма (3НФ)**](#3-третья-нормальная-форма-3нф)
  - [**4. Нормальная форма Бойса-Кодда (НФБК)**](#4-нормальная-форма-бойса-кодда-нфбк)
  - [**5. Четвёртая нормальная форма (4НФ)**](#5-четвёртая-нормальная-форма-4нф)
  - [**6. Пятая нормальная форма (5НФ)**](#6-пятая-нормальная-форма-5нф)
- [**Когда нормализация не нужна?**](#когда-нормализация-не-нужна)
- [**Пример нормализации:**](#пример-нормализации)
